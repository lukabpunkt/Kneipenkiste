...
**Status:** M0 abgeschlossen (`v0.0.1`) — Regelkern, FSM und Choreographer stehen als getestete reine Funktionen. Als Nächstes M1: der komplette UI-Flow mit Platzhalter-Schritt.
