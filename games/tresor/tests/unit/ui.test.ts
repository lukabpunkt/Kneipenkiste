...
describe('i18n-Abdeckung der Screens', () => {
  ...
  const USED_KEYS = [
    ...
    'result.traitor',
    'result.history',
    'result.historyEvening',
    'result.historyEvenings',
    'settings.forgetHistory',
    'settings.historyGone',
    ...
    'update.cta',
    'modes.comboOathMole',
    'modes.comboOathNight',
    'modeGuide.headline',
    'modeGuide.intro',
    'modeGuide.oath.title',
    'modeGuide.mole.title',
    'modeGuide.nightShift.title',
    'modeGuide.highroller.title',
    'modeGuide.witness.title',
