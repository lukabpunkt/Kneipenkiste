/**
 * Kleine DOM-Animationshelfer für die Menü-Screens.
 *
 * PIXI und GSAP bleiben im Tresorraum — hier reicht `Element.animate` und ein
 * `requestAnimationFrame`-Zähler. Das hält den Renderer aus dem Einstiegs-Chunk
 * (Architektur §1: Reveal-Chunk lazy).
 *
