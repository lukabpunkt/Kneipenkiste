 ...
 *
 * Quelle: `audio-src/*.wav`
 * Ziel:   `public/audio/tresor.{ogg,mp3}` + `src/audio/sprite.json`
 *
 * TODO(M3): Sprite-Bau (ffmpeg oder audiosprite) nach der Sound-Liste in docs/01-GDD.md §6.
 */
