 ...
 *
 * Fehlende Keys liefern `[missing:key]` — dieser Marker wird im A5-Audit (`npm run lint` + Vollstaendigkeitstest) gegrept.
 */
...
/**
 * Listen-Keys (Art Direction §9): Manche Anlaesse haben mehrere Textvarianten.
 * Fehlt der Key oder ist es keine Liste, kommt ein leeres Array zurueck — der
 * Text bleibt dann einfach leer, statt dass die Runde abbricht.
 */
