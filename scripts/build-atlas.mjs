 ...
 *
 * Regeln (Architektur §8): eine Textur je Kategorie, damit die Halle mit wenigen
 * Draw-Batches auskommt (Audit A2: ≤ 3). Atlas-Kante ≤ 2048 px je Auflösung.
 *
...
/*
 * Vier Atlanten statt einem: Die Halle steht immer, die Shotlings auch — aber die
 * Röntgen-Silhouetten braucht nur der Monitor, und Items nur beim Öffnen. Getrennte
 * Texturen lassen sich einzeln nachladen und halten die Batches trotzdem klein, weil
 * nie zwei Kategorien im selben Layer stecken.
 */
const CATEGORIES = [
