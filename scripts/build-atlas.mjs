 ...
 *
 * Regeln (Architektur §8): eine Textur je Kategorie, damit das Feld mit wenigen
 * Draw-Batches auskommt — Audit A2 verlangt höchstens drei. Atlas-Kante ≤ 2048 px.
 *
 * Frame-Namen entsprechen dem Pfad ohne Endung, z. B. `faces/sweat`, `gear/helmet`,
 * `plates/plate_top`, `fx/temp_hot`.
 */
...
const CATEGORIES = [
  { name: 'diggers', dir: 'diggers' },
  { name: 'board', dir: 'board' },
];
