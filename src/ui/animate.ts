 ...
 *
 * PIXI und GSAP bleiben in der Zollhalle — hier reicht `Element.animate` und ein
 * `requestAnimationFrame`-Zähler. Das spart den Renderer im Einstiegs-Chunk (Architektur §1: Hall-Chunk lazy).
 *
