 ...
 *
 * PIXI und GSAP bleiben in der Schlucht — hier reicht `Element.animate` und ein
 * `requestAnimationFrame`-Zähler. Das spart den Renderer im Einstiegs-Chunk
 * (Architektur §1: Step-Chunk lazy während der Absprache).
 *
